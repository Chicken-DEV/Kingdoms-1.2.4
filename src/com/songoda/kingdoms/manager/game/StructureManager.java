...
public class StructureManager extends Manager implements Listener{
	...
	public static ItemStack getPowerCellDisk(){
	      ...
	      i1m.setDisplayName(Kingdoms.getLang().getString("Structures_Powercell"));
	      ArrayList i1l = new ArrayList();
	      i1l.add(Kingdoms.getLang().getString("Structures_Powercell_Desc"));
	      i1l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	...
	public static ItemStack getWarpPadDisk(){
	      ItemStack i1 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i1m = i1.getItemMeta();
	      i1m.setDisplayName(Kingdoms.getLang().getString("Structures_WarpPad"));
	      ArrayList i1l = new ArrayList();
	      i1l.add(Kingdoms.getLang().getString("Structures_WarpPad_Desc"));
	      i1l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i1m.setLore(LoreOrganizer.organize(i1l));
	      i1.setItemMeta(i1m);
	...
	public static ItemStack getOutpostDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_Outpost"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_Outpost_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	...
	public static ItemStack getSiegeEngineDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_SiegeEngine"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_SiegeEngine_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
	...
	public static ItemStack getShieldBatteryDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_ShieldBattery"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_ShieldBattery_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
	...
	public static ItemStack getExtractorDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_Extractor"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_Extractor_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
	...
	public static ItemStack getRegulatorDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_Regulator"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_Regulator_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
	...
	public static ItemStack getRadarDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_Radar"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_Radar_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
	...
	public static ItemStack getArsenalDisk(){
	      ItemStack i2 = new ItemStack(Materials.MUSIC_DISC_BLOCKS.parseMaterial());
	      ItemMeta i2m = i2.getItemMeta();
	      i2m.setDisplayName(Kingdoms.getLang().getString("Structures_Arsenal"));
	      ArrayList i2l = new ArrayList();
	      i2l.add(Kingdoms.getLang().getString("Structures_Arsenal_Desc"));
	      i2l.add(Kingdoms.getLang().getString("Structures_Placement_Instructions"));
	      i2m.setLore(LoreOrganizer.organize(i2l));
	      i2.setItemMeta(i2m);
